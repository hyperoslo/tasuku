...
ActiveRecord::Schema.define(version: 20140526130322) do
  ...
  add_index "tasuku_tasks", ["taskable_id", "taskable_type"], name: "index_tasks_tasks_on_taskable_id_and_taskable_type"
